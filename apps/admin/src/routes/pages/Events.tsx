        ...
        <Modal closeOnOverlayClick={false} isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <ModalBody pb={6}>
              ...
              <Input
                type="datetime-local"
                defaultValue={convertToCST(event.startTime).format(
                  "yyyy-MM-DDTHH:mm"
                )}
                mb={4}
                onChange={(e) =>
              ...
              <Input
                type="datetime-local"
                defaultValue={convertToCST(event.endTime).format(
                  "yyyy-MM-DDTHH:mm"
                )}
                mb={4}
                onChange={(e) =>
        ...
        <CardBody>
          ...
          <Stack mt="6" spacing="3">
            ...
            <Text>
              ...
              {moment
                .duration(
                  convertToCST(event.endTime).diff(
                    convertToCST(event.startTime)
                  )
                )
                .humanize()}
              )
