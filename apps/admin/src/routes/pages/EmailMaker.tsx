              ...
              <CardBody>
                ...
                >
                  ...
                  <FormControl
                    isRequired
                    isInvalid={
                      ((values.isMobileNotification || !values.isIndividualEmail) &&
                        !!errors.recipients &&
                        touched.recipients) ||
                      (!values.isMobileNotification && values.isIndividualEmail &&
                        !!errors.individualRecipient &&
                        touched.individualRecipient)
                    }
                  >
                    <Flex w="100%" flexWrap="wrap" gap={2}>
                      ...
                      {values.isMobileNotification ? (
                        ...
                        <Input
                          ...
                          placeholder="Individual Recipient"
                          value={values.individualRecipient}
                          onChange={handleChange}
                          flex={1}
                        />
                      ) : (
                      ...
                      {!values.isMobileNotification && <Button
                        type="button"
